...
function handleSetSummary(body: SetSummaryRequest): void {
  // Schema is `summary TEXT NOT NULL DEFAULT ''` — coalesce a missing/undefined summary to ''
  // so bun:sqlite doesn't throw "NOT NULL constraint failed: peers.summary" (500 to the client).
